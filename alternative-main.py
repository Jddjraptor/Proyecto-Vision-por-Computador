...
# Elimina la pausa automática que PyDirectInput
# agrega después de cada pulsación
...
# ------------------------------------------------
# VARIABLES PARA SUAVIZADO DE MIRADA
# ------------------------------------------------
...
def eye_aspect_ratio(landmarks, eye_points, w, h):
    ...
    p1 = np.array([
        landmarks[eye_points[1]].x * w,
        landmarks[eye_points[1]].y * h
    ])

    # Punto inferior del ojo
    p2 = np.array([
        landmarks[eye_points[5]].x * w,
        landmarks[eye_points[5]].y * h
    ])

    # Extremo izquierdo
    p3 = np.array([
        landmarks[eye_points[0]].x * w,
        landmarks[eye_points[0]].y * h
    ])

    # Extremo derecho
    p4 = np.array([
        landmarks[eye_points[3]].x * w,
